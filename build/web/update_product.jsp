...
<div class="wrapper">
 ...
 <div class="spacing"></div>
  ...
  <%
      ...
      <br>
         <form action="update3" class="form" method="post">
        <input type="number" id="id" name="id" placeholder=" Your Product Id:" value="<%=rs.getInt(1)%>" /> <br />

        <label for="Name"></label>
        <input type="text" id="name" name="name" placeholder="Enter Product Name:" value="<%=rs.getString(2)%>" /> <br />

        <label for="price"></label>
        <input type="number" id="price" name="price" placeholder="Enter Product Price:" value="<%=rs.getString(3)%>"/> <br />

        <label for="username"></label>
        <input type="text" id="image_location" name="image_location" placeholder="Insert Product Image:" value="<%=rs.getString(4)%>" /> <br />

        <!-- <a href="#" class="mainButton">LOGIN</a> -->
        <button type="submit" class="mainButton">Update</button>
    </form>
       <% 
                            con.close();
       %>
