...
<head>
  ...
  <link rel="stylesheet" href="CSS/add_product_nepal.css">
 ...
 <!-- <div class="spacing"></div> -->
  ...
  <div class="Container1">
    <div class="textContainer1">
      ...
      <h1 class="Header">
         Add Poultry Nepal Products Here!
      </h1>

      
      <br>
        <form action="admin_add_products" method="post">
        <input type="number" id="id" name="id" placeholder=" Your Product Id:"  min="400" max="500"/> <br />
