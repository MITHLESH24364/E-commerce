...
<body>
  ...
  <div id="slideshow">
    <div class="slide-wrapper">
      <div class="slide">
        <h1 class="slide-number"><img src="image/martslide4.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
        <h1 class="slide-number"><img src="image/martslide1.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
        <h1 class="slide-number"><img src="image/martslide2.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
        <h1 class="slide-number"><img src="image/martslide3.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
        <h1 class="slide-number"><img src="image/martslide5.png" width="100%" height="100%" alt=""/></h1>
      </div>
    </div>
  </div>
...
<!--  <div class="spacing"></div>-->
  ...
  <h1 class="Title">Welcome To Mart</h1>
...
<!--  <div class="spacing"></div>
 ...
 //here sonoo is database name, root is username and password  
                    ...
                    ResultSet rsq = stm.executeQuery("select * from products where id >200 and id < 300");
                    while (rsq.next()) {
