 ...
 * @author user
 */
@WebServlet(name = "NewPassword1", urlPatterns = {"/NewPassword1"})
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet NewPassword1</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet NewPassword1 at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
