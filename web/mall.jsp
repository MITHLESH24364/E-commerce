...
<body>
  ...
  <div id="slideshow">
    <div class="slide-wrapper">
      <div class="slide">
        <h1 class="slide-number"><img src="image/mallslide1.png" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
        <h1 class="slide-number"><img src="image/mallslide2.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
        <h1 class="slide-number"><img src="image/mallslide3.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
        <h1 class="slide-number"><img src="image/mallslide4.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
...
<!--  <div class="spacing"></div>-->
  ...
  <h1 class="Title">Welcome To Mall</h1>
...
<!--  <div class="spacing"></div>
 ...
 //here sonoo is database name, root is username and password  
                    ...
                    ResultSet rsq = stm.executeQuery("select * from products where id >300 and id < 400");
                    while (rsq.next()) {
