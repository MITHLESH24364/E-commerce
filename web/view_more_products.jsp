...
<head>
    ...
    <link rel="stylesheet" href="CSS/view_more_products.css">
...
<div class="wrapper">
 ...
 <div class="spacing"></div>
    ...
    <div class="spacing"></div>
<h1 class="admin">View For You Products</h1>
 ...
 //here sonoo is database name, root is username and password  
                    ...
                    ResultSet rs = stmt.executeQuery("select * from products where id >100 and id < 200");
                    while (rs.next()) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="editButton"><i class="fa fa-edit"> </i> Edit</div>
                      ...
                      <td>
                    <form action="more_product_delete?id=<%=rs.getString(1)%>" method="post">
