...
<body>
  ...
  <div id="slideshow">
    <div class="slide-wrapper">
      <div class="slide">
        <h1 class="slide-number"><img src="image/fashionslide1.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
        <h1 class="slide-number"><img src="image/fashionslide2.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
...
<!--  <div class="spacing"></div>-->
  ...
  <h1 class="Title">Welcome To Fashion</h1>
...
<!--  <div class="spacing"></div>
 ...
 //here sonoo is database name, root is username and password  
                    ...
                    ResultSet rsq = stm.executeQuery("select * from products where id >500 and id < 600");
                    while (rsq.next()) {
