...
<head>
    ...
    <link rel="stylesheet" href="CSS/view_nepal.css">
...
<div class="wrapper">
 ...
 <div class="spacing"></div>
    ...
    <div class="spacing"></div>
<h1 class="admin">View Proudly Nepal Products</h1>
 ...
 //here sonoo is database name, root is username and password  
                    ...
                    ResultSet rs = stmt.executeQuery("select * from products where id >400 and id < 500");
                    while (rs.next()) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="editButton"><i class="fa fa-edit"> </i> Edit</div>
                      ...
                      <td>
                    <form action="delete_nepal?id=<%=rs.getString(1)%>" method="post">
