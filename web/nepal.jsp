...
<body>
  ...
  <div id="slideshow">
    <div class="slide-wrapper">
      <div class="slide">
        <h1 class="slide-number"><img src="image/nepalslide2.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
        <h1 class="slide-number"><img src="image/nepalslide1.jpg" width="100%" height="100%" alt=""/></h1>
      </div>
      <div class="slide">
...
<!--  <div class="spacing"></div>-->
  ...
  <h1 class="Title">Welcome To Proudly Nepal</h1>
...
<!--  <div class="spacing"></div>
 ...
 //here sonoo is database name, root is username and password  
                    ...
                    ResultSet rsq = stm.executeQuery("select * from products where id >400 and id < 500");
                    while (rsq.next()) {
