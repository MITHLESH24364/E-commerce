...
<head>
    ...
    <link rel="stylesheet" href="CSS/view_mart.css">
...
<div class="wrapper">
 ...
 <div class="spacing"></div>
    ...
    <div class="spacing"></div>
<h1 class="admin">View Mart Products</h1>
 ...
 //here sonoo is database name, root is username and password  
                    ...
                    ResultSet rs = stmt.executeQuery("select * from products where id >200 and id < 300");
                    while (rs.next()) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="editButton"><i class="fa fa-edit"> </i> Edit</div>
                      ...
                      <td>
                    <form action="delete_mart?id=<%=rs.getString(1)%>" method="post">
