...
<head>
  ...
  <link rel="stylesheet" href="CSS/clintpage.css">
...
<body>
  ...
  <h1 class="Title">Today's Flash Sale mks</h1>
        ...
        <div class="product-card">
          <div class="product-image">
              <a href="first_product.jsp?id=<%=rs.getInt(1)%>">
                  <img src="image/<%=rs.getString("image_location")%>" width="100%" height="100%" class="product-thumb" alt=""></a>
          </div>
